...
if ( !class_exists( 'MeowKit_MWMAIL_Helpers' ) ) {

  class MeowKit_MWMAIL_Helpers {
    //public static $version = MeowKit_MWMAIL_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MWMAIL_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MWMAIL_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MWMAIL_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MWMAIL_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MWMAIL_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MWMAIL_Helpers::is_rest() ) {
