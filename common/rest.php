...
class MeowKit_MWMAIL_Rest {
  private $namespace = 'meow-common/v1';
  public static $instance = null;

  public static function init_once() {
    if ( !MeowKit_MWMAIL_Rest::$instance ) {
      MeowKit_MWMAIL_Rest::$instance = new self();
    }
  }
  ...
  public function rest_error_logs( $request ) {
    return new WP_REST_Response( [ 'success' => true, 'data' => MeowKit_MWMAIL_Helpers::php_error_logs() ], 200 );
  }
